<script lang="ts">
    ...
    const defaultKeywords =
        'calendar, schedule management, scheduler, planner, team calendar, shared calendar, drag and drop calendar, work schedule, meeting schedule, project management, time management, productivity tool, schedule sharing, recurring events, reminders, event planning, task management'
...
<svelte:head>
    ...
    <meta property="og:image:alt" content="Calendar - Intuitive monthly calendar view with event management interface" />
    ...
    <meta name="twitter:image:alt" content="Calendar - Intuitive monthly calendar view with event management interface" />
