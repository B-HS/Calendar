<script lang="ts">
	...
	const features = $derived([
		{ icon: MousePointerClick, title: t.landing.feature1Title, description: t.landing.feature1Description },
		{ icon: Link, title: t.landing.feature2Title, description: t.landing.feature2Description },
		{ icon: Globe, title: t.landing.feature4Title, description: t.landing.feature4Description },
		{ icon: Smartphone, title: t.landing.feature5Title, description: t.landing.feature5Description },
		{ icon: CloudUpload, title: t.landing.feature6Title, description: t.landing.feature6Description }
	])
...
<svelte:head>
	<title>Global Calendar - {t.landing.heroSubtitle}</title>
	<meta name="description" content={t.landing.heroDescription} />
</svelte:head>
...
<main class="min-h-screen">
	...
	<section id="demo-section" class="observe-section bg-muted/30 px-4 py-20">
		<div class="mx-auto max-w-6xl">
			<div class="animate-item mb-12 text-center" class:animate-show={demoVisible}>
				<h2 class="mb-4 text-3xl font-bold sm:text-4xl">{t.landing.demoTitle}</h2>
				<p class="text-muted-foreground">{t.landing.demoDescription}</p>
			</div>
	...
	<section id="features-section" class="observe-section px-4 py-20">
		<div class="mx-auto max-w-6xl">
			<div class="animate-item mb-16 text-center" class:animate-show={featuresVisible}>
				<h2 class="mb-4 text-3xl font-bold sm:text-4xl">{t.landing.featuresTitle}</h2>
	...
	<section id="how-to-use-section" class="observe-section bg-muted/30 px-4 py-20">
		<div class="mx-auto max-w-4xl">
			<div class="animate-item mb-16 text-center" class:animate-show={howToUseVisible}>
				<h2 class="mb-4 text-3xl font-bold sm:text-4xl">{t.landing.howToUseTitle}</h2>
				<p class="text-muted-foreground">{t.landing.howToUseSubtitle}</p>
			</div>
	...
	<section id="pricing-section" class="observe-section px-4 py-20">
		<div class="mx-auto max-w-lg">
			<div class="animate-item mb-12 text-center" class:animate-show={pricingVisible}>
				<h2 class="mb-4 text-3xl font-bold sm:text-4xl">{t.landing.pricingTitle}</h2>
				<p class="text-muted-foreground">{t.landing.pricingSubtitle}</p>
			</div>
			...
			>
				...
				<div class="mb-2 text-5xl font-bold">{t.landing.pricingFree}</div>
				<div class="mb-8 text-muted-foreground">{t.landing.pricingDescription}</div>
	...
	<footer class="border-t bg-muted/30 px-4 py-8">
		<div class="mx-auto max-w-6xl text-center">
			...
			<p class="text-sm text-muted-foreground">{t.landing.footerDescription}</p>
		</div>
	</footer>
</main>
